...
var articles={
    'article-one': {
    title: "Article One | Prasad",
    heading:"Article One",
    date: "8 Feb,2017",
    content:`<p>
				this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.this is the first article.
			</p>
			<p>
...
app.get('/submit-name/:name', function(req, res){
    // get the name the from the request
